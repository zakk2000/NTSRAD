...
<tiles:importAttribute name="userDefinedJs" />
<c:forEach var="userDefinedJsItem" items="${userDefinedJs}">
	<script type="text/javascript" src="<c:url value="${userDefinedJsItem}" />"></script>
</c:forEach>
